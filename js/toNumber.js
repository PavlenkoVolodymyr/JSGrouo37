...
console.log(`тип даных ${value}, через конструктор Number():`, typeof toNumber)

// 2й способ
toNumber = +value
console.log(`${value}, через унарный +:`, toNumber)
console.log(`тип даных ${value}, через унарный +:`, typeof toNumber)
...
console.log(
  `тип даных пустой строки ${value}, через конструктор Number():`,
  typeof toNumber,
)
...
console.log(
  `тип даных пустой строки ${value}, через унарный +:`,
  typeof toNumber,
)
...
console.log(
  `тип даных строки спробелом ${value}, через конструктор Number():`,
  typeof toNumber,
)
...
console.log(
  `тип даных строки  с пробелом ${value}, через унарный +:`,
  typeof toNumber,
)
