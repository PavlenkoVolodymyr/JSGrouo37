...
console.log(
  `тип даных ${value}, через конструктор Boolean():`,
  typeof toBoolean,
)
...
console.log(`тип даных ${value}, через !!:`, typeof toBoolean)
...
console.log(
  `тип даных пустой строки ${value}, через конструктор Boolean():`,
  typeof toBoolean,
)
...
console.log(`тип даных пустой строкі ${value}, через !!:`, typeof toBoolean)
...
console.log(
  `тип даных строки с пробелом ${value}, через конструктор Boolean():`,
  typeof toBoolean,
)
...
console.log(`тип даных строки с пробелом ${value}, через !!:`, typeof toBoolean)
